...
Throughout this guide, you'll type commands in the **Terminal** (also called "command line"):
- Open it: Press `Ctrl + Alt + T`
- You'll see something like: `username@computer:~$`
- Type or paste commands after the `$` symbol
...
**Time:** 30-60 minutes (downloads large files)
...
- `~/workingdir/` - Your designs (most important!)
- `~/tools/` - Compiled tools (~5GB, can be recreated)
- `~/openpdk/` - PDK (~80GB, can be recreated but takes time)
- `~/.bashrc` - Environment configuration

**Note:** The SkyWater PDK is very large (~80GB) because it contains detailed information about every component you can use to design chips. This is normal and necessary for professional chip design.

---

## 🙏 Credits & Thanks

- **SkyWater PDK:** Google and SkyWater Technology
- **Magic VLSI:** Tim Edwards
- **Xschem:** Stefan Schippers
- **Ngspice:** The Ngspice team
...
This guide is provided as-is for educational purposes. The tools mentioned have their own licenses - please check each project's license before use.
...
5. Ask in VLSI/EDA communities online

**Remember:** Everyone struggles with this installation at first. You're doing great! 🚀
